...
export const EmptyInstallation: React.FC<EmptyInstallationProps> = ({
  onConnect,
}) => {
  return (
    <div className="relative overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 sm:p-12 shadow-lg max-w-4xl mx-auto my-6 animate-fade-in">
      ...
      <div className="relative flex flex-col items-center text-center">
        ...
        <p className="mt-4 text-sm sm:text-base text-zinc-600 dark:text-zinc-400 max-w-xl leading-relaxed">
          Connect your GitHub account or organizations to start auto-generating,
          evaluating, and monitoring developer-friendly documentation for your
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
            <div className="flex items-start gap-2.5 text-left">
              ...
              <div>
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-0.5">
                  Read-only permissions for repository lists, branches, and file
                  paths.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5 text-left">
              ...
              <div>
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-0.5">
                  Write permissions are strictly scoped to opening PRs for
            ...
            <div className="flex items-start gap-2.5 text-left">
              ...
              <div>
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-0.5">
                  Receives push and PR events to keep documentation instantly
                  synchronized.
                </p>
              </div>
            </div>
