...
const navItems = [
  ...
  { label: 'Repositories',  href: '/repositories',         Icon: IconRepositories, exact: false },
  { label: 'Workflow Runs', href: '/runs',                  Icon: IconRuns,         exact: false },
  { label: 'Pull Requests', href: '/pull-requests',         Icon: IconPullRequests, exact: false },
  { label: 'Human Reviews', href: '/reviews',               Icon: IconReviews,      exact: false },
  { label: 'Integrations',  href: '/settings/integrations', Icon: IconIntegrations, exact: false },
