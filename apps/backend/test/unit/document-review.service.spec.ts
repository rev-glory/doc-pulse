...
describe('DocumentReviewService Orchestrator Unit Tests', () => {
  const mockContextBuilder = {
    buildContext: async () => ({ repositoryName: 'test-repo', formattedSummary: 'summary' }),
  } as any;
  ...
  it('should successfully handle partial missing document evaluations in batch response', async () => {
    ...
    const result = await service.reviewDocuments(dummyRepository, dummyInventory, docs, 'test-run');
